...
function setupOverlayLayers(map) {
	...
	if(useFiskeGjesdal) {
		...
		overlayMaps["<i class='fa fa-tint' aria-hidden='true'></i> Fiskeplass Gjesdal"] = fiskeplassGjesdal;
	}
	...
	if(useWeatherData){
		...
		overlayMaps["<i class='fa fa-sun-o' aria-hidden='true'></i> Vær data"] = værData;

		var værDataPost = weatherDataPostCode(map);
		overlayMaps["<i class='fa fa-sun-o' aria-hidden='true'></i> Vær data post kode"] = værDataPost;
	}
