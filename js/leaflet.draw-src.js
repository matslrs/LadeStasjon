...
(function(window, document, undefined) {
	...
	L.Edit.PolyVerticesEdit = L.Handler.extend({
		...
		_fireEdit: function() {
			...
			this._poly._map.fire('draw:editvertex', {
				layers: this._markerGroup
			});
		},
		...
		_checkDisabled: function() {
			...
			if (this.options.edit) {
				...
				button.setAttribute(
					'title',
					hasLayers ?
					L.drawLocal.edit.toolbar.buttons.edit : L.drawLocal.edit.toolbar.buttons.editDisabled
				);
			}
			...
			if (this.options.remove) {
				...
				button.setAttribute(
					'title',
					hasLayers ?
					L.drawLocal.edit.toolbar.buttons.remove : L.drawLocal.edit.toolbar.buttons.removeDisabled
				);
			}
		}
	});
